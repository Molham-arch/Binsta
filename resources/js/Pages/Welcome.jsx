...
export default function Welcome() {
    return (
        <>
            <Head title="Welkom bij Binsta" />
            <div className="min-h-screen flex flex-col justify-center items-center bg-gray-100 text-center px-4">
                <h1 className="text-4xl font-bold text-blue-600 mb-2">🔥 Binsta</h1>
                <p className="text-lg text-gray-600 mb-6">Code, share & connect.</p>

                <div className="space-x-4">
                    <Link href={route('login')} className="text-blue-600 font-semibold hover:underline">Log in</Link>
                    <Link href={route('register')} className="text-blue-600 font-semibold hover:underline">Registreren</Link>
                </div>
            </div>
        </>
    );
